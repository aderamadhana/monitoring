        ...
        <table class="table table-striped" id="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $data->STATUS_KEGIATAN_HARIAN?></td>
                    <td> 
                        <a href="<?= site_url('ValidasiKegiatan/detail_harian/'.$data->ID_KEGIATAN_BULANAN ); ?>" class="btn btn-xs btn-success" title="Detail Kegiatan"><i class="mdi mdi-eye"></i> </a>
                    </td>
                </tr>
                <?php }?>
            </tbody>
