...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2022 at 01:50 PM
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `UPDATE_DATA` AFTER UPDATE ON `kegiatan_harian` FOR EACH ROW UPDATE kegiatan_bulanan SET kegiatan_bulanan.TARGET_TEREALISASI = kegiatan_bulanan.TARGET_TEREALISASI + 1 WHERE kegiatan_bulanan.ID_KEGIATAN_BULANAN = new.ID_KEGIATAN_BULANAN AND new.STATUS_KEGIATAN_HARIAN = "Tervalidasi"
$$
DELIMITER ;
...
(14, '125', NULL, 'Halo', 'Halo', '2022-01-22', 'Halo', 'Laki-Laki', 'Halo', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', 'Halo', 'Kriminal', 'Halo', '', '2022-01-22', '22:10:00', '2022-01-22 10:11:02', 'Belum Tervalidasi', NULL, NULL),
(15, '125', NULL, 'Halo', 'Halo', '2022-01-22', 'Halo', 'Laki-Laki', 'Halo', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', 'Halo', 'Kriminal', 'Halo', '', '2022-01-22', '17:12:00', '2022-01-22 10:12:50', 'Belum Tervalidasi', NULL, NULL),
(16, '125', NULL, 'Halo', 'Halo', '2022-01-22', 'Halo', 'Laki-Laki', 'Halo', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', 'Halo', 'Kriminal', 'Halo', '', '2022-01-22', '17:33:00', '2022-01-22 10:34:02', 'Belum Tervalidasi', NULL, NULL),
(17, '125', NULL, 'Halo', 'Halo', '2022-01-22', 'Halo', 'Laki-Laki', 'Halo', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', 'Halo', 'Kriminal', 'Halo', '', '2022-01-22', '17:47:00', '2022-01-22 10:47:33', 'Belum Tervalidasi', NULL, NULL),
(18, '125', NULL, 'halo', 'halo', '2022-01-22', 'halo', 'Laki-Laki', 'halo', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', 'halo', 'Kriminal', 'halo', '', '2022-01-22', '17:49:00', '2022-01-22 10:51:05', 'Belum Tervalidasi', NULL, NULL),
(19, '125', NULL, 'BUKTI', 'BUKTI', '2022-01-22', 'BUKTI', 'Laki-Laki', 'BUKTI', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', '', '', '0000-00-00', '', '-', 'BUKTI', 'Kriminal', 'BUKTI', 'http://localhost/monitoring/assets/img/kejadian/BATCH_4.jpg', '2022-01-22', '18:09:00', '2022-01-22 11:23:57', 'Belum Tervalidasi', NULL, NULL);
...
--
ALTER TABLE `anggota_polres`
  MODIFY `ID_ANGGOTA_POLRES` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `kegiatan_harian`
  MODIFY `ID_KEGIATAN_HARIAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=143;

--
-- AUTO_INCREMENT for table `kejadian`
--
ALTER TABLE `kejadian`
  MODIFY `ID_KEJADIAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
